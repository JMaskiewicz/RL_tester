"""
Transformer based PPO agent for trading version 1.1
...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, n_heads=4, n_layers=3, dropout_rate=0.1, static_input_dims=1):
        ...
        self.fc_out = nn.Linear(input_dims * 2, n_actions)
...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, n_heads=4, n_layers=3, dropout_rate=0.1, static_input_dims=1):
        ...
        self.positional_encoding = nn.Parameter(torch.zeros(1, self.max_position_embeddings, input_dims))
        self.fc_static = nn.Linear(static_input_dims, input_dims)
        self.fc_out = nn.Linear(input_dims * 2, 1)
